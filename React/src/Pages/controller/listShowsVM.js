...
export function listShowsVMCon(requestRedraw) {
    ...
    let venueToken = document.getElementById("token");
     ...
     let data = {'token': venueToken.value}
       ...
       let table = '<table border="1"><tr><th>Name</th><th>ShowID</th><th>isActive</th><th>isSoldOut</th><th>ShowDate</th><th>ShowTime</th><th>DefaultPrice</th><th>AvailableSeatsCounter</th><th>Revenue</th><th>Venue</th></tr>';
